class OrderItemsController < ApplicationController
  ...
  def create
    ...
    # If order/cart.html.erb has not been created
    ...
    # If order has been created with items in cart.html.erb
    else
...
# # Update quantity of item in order/cart.html.erb
#   def update
#     check_stock(@order_item.product)
#
#     if @order_item.update(order_item_params)
#       flash[:success] = "Successfully updated cart.html.erb"
#       redirect_back(fallback_location: root_path)
#       return
#     else
#       flash[:error] = "A problem occurred. Could not update item in cart.html.erb"
...
#   end
#
#   # Remove item from order/cart.html.erb
#   def destroy
#     if @order_item.destroy
#       flash[:success] = "Successfully removed item from cart.html.erb"
#       redirect_back(fallback_location: root_path)
#       return
#     else
#       flash[:error] = "A problem occurred. Could not remove item from cart.html.erb"
#       flash[:validation_error] = @order_item.errors.messages
#       redirect_back(fallback_location: root_path)
#       return
#     end
#   end
  ...
  def check_stock(product)
    ...
    # If quantity is 0 and OrderItem has been created / is in the cart.html.erb, remove it from the cart.html.erb
    ...
    unless product.in_stock?(order_quantity)
      flash[:error] = "A problem occurred. #{product.name} was not added to the cart.html.erb. Only #{product.quantity} available"
      redirect_back(fallback_location: root_path)
      return
    end
  end
